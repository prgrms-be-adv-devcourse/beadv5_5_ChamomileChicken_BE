...
public enum SettlementBatchErrorCode implements ErrorCode {
	...
	SETTLEMENT_TARGET_LOAD_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "정산 대상 적재 배치 실행에 실패했습니다."),
	...
	SETTLEMENT_BATCH_CURSOR_NOT_FOUND(HttpStatus.NOT_FOUND, "정산 배치 커서 정보를 찾을 수 없습니다."),
	SETTLEMENT_SOURCE_SYNC_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "원천 데이터 동기화 중 오류가 발생했습니다.");
