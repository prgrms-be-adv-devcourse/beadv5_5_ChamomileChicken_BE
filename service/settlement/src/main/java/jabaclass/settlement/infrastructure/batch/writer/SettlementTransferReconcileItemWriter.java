...
public class SettlementTransferReconcileItemWriter implements ItemWriter<Settlement> {
	...
	public void write(Chunk<? extends Settlement> items) {
		...
		settlementTransferService.reconcileTransferringSettlements(settlements);
	}
}
