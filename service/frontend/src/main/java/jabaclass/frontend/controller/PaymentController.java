...
public class PaymentController {
	...
	@PostMapping("/prepare")
	@ResponseBody
	public ResponseEntity<Map<String, String>> prepare(@RequestBody PreparePaymentRequest request,
		HttpSession session) {
	...
	public String refund(
		...
		try {
			...
			// 환불 성공 시 세션에 기록 (비동기 처리 지연 대응)
			// session.setAttribute("refunded_order_" + orderId, true);
